...
const ProductReportService_1 = require("../../services/admin/ProductReportService");
    ...
    list(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const data = yield ProductReportService_1.default.list(queryString);
                if (data) {
                    res.logMsg = `Product Report list fetched Successfully`;
                    return ResponseHelper_1.default.ok(res, res.__("product_report_list"), data);
                }
            }
            catch (error) {
                next(error);
