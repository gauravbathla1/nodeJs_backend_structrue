...
const GroupService_1 = require("../../services/app/GroupService");
...
class GroupController {
    ...
    createGroup(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const group = yield GroupService_1.default.createGroup(req.user._id, groupData, groupData.purpose, groupData.others, groupIcon);
                res.logMsg = 'Group created';
                return ResponseHelper_1.default.created(res, res.__('group_created'), { group });
            }
            catch (error) {
                next(error);
            }
    ...
    groupList(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const query = GroupModel_1.default.find({ isDeleted: false, createdBy: req.user._id });
                const countQuery = GroupModel_1.default.find({ isDeleted: false, createdBy: req.user._id });
    ...
    groupDetails(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!exist) {
                    return ResponseHelper_1.default.badRequest(res, res.__('group_not_exist'));
                }
                const group = yield GroupService_1.default.groupDetails(groupId, req.user._id);
    ...
    editGroup(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const groupId = req.params.id;
                const { groupIcon } = req.files;
                const group = yield GroupService_1.default.editGroup(groupId, req.body, groupIcon);
                res.logMsg = 'Group edited';
                return ResponseHelper_1.default.ok(res, res.__('group_edited'), { group });
            }
            catch (error) {
                next(error);
            }
    ...
    deleteGroup(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const groupId = req.params.id;
                yield GroupMemberModel_1.default.updateMany({ group: groupId }, { isDeleted: true });
                /* deleting subgroup and its members */
                yield SubgroupModel_1.default.deleteMany({ groupId });
                yield SubgroupMember_1.default.deleteMany({ groupId });
                const group = yield GroupModel_1.default.findByIdAndUpdate(groupId, { isDeleted: true }, { new: true });
                res.logMsg = 'Group deleted';
                return ResponseHelper_1.default.ok(res, res.__('group_deleted'), { group });
            }
            catch (error) {
                next(error);
            }
    ...
    /**
        ...
        *
        */
    groupPurpose(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const queryString = req.query;
                const query = GroupPurPoseModel_1.default.find({ isActive: true });
                const countQuery = GroupPurPoseModel_1.default.find({ isActive: true });
                const listFeature = new ApiFeatures_1.ApiFeatures(query, queryString)
                    .filtering()
                    .searching(['text'])
                    .sorting('-createdAt')
                ...
                const list = yield listFeature.query;
                res.logMsg = 'Group list fetched.';
                return ResponseHelper_1.default.ok(res, res.__('group_purpose_list'), { list, count });
            }
            catch (error) {
                next(error);
            }
    ...
    /**
                ...
                *
                */
    removeGroupMember(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { memberId } = req.body;
                const groupId = req.params.id;
                const result = yield GroupService_1.default.removeMember(groupId, memberId, req.user._id);
                if (result.groupNotExist)
                ...
                if (result.notGroupMember)
                    return ResponseHelper_1.default.badRequest(res, res.__('Invalid_GroupId_Or_MemberId'));
                res.logMsg = `Group member removed *${memberId}* from group *${groupId}*`;
                return ResponseHelper_1.default.ok(res, res.__('group_member_removed'), { group: result.group });
            }
            catch (error) {
                next(error);
            }
    ...
    searchGroup(req, res, next) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const data = yield GroupService_1.default.searchGroup(queryString, userId);
                res.logMsg = ` Group list fetched successfully`;
                return ResponseHelper_1.default.ok(res, res.__('group_search_list'), data);
            }
            catch (error) {
                next(error);
            }
    ...
    searchSuggestions(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const results = yield GroupModel_1.default.find(match)
                    .sort({ searchKey: 1 })
                    .limit(100)
                    .distinct(searchKey);
                res.logMsg = `Group search suggestions list for`;
                return ResponseHelper_1.default.ok(res, res.__('search_suggestions'), { results });
            }
            catch (error) {
                next(error);
            }
    ...
    featuredGroup(req, res, next) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const count = yield GroupModel_1.default.countDocuments(match);
                const list = yield GroupModel_1.default.find(match, {
                    _id: 1,
                    name: 1,
                    groupCode: 1,
                    purposeText: 1,
                ...
                return ResponseHelper_1.default.ok(res, res.__('featured_group_list'), { count, list });
            }
            catch (error) {
                next(error);
            }
    ...
    /**
       ...
       * @apiSuccessExample {json} Success-Response
        ...
        *    }
       */
    topCashBackGroups(req, res, next) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const userId = ((_a = req.user) === null || _a === void 0 ? void 0 : _a._id) || req.query.userId;
                ...
                return ResponseHelper_1.default.ok(res, res.__('top_cashback_group_list'), { count, list });
            }
            catch (error) {
                next(error);
            }
    ...
    allGroupList(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let skip = (page - 1) * limit;
                const search = req.query.search;
                const result = yield GroupService_1.default.allGroupList(userId, skip, limit, search);
                res.logMsg = `all group list fetched by *${userId}*`;
                return ResponseHelper_1.default.ok(res, res.__('all_group_list'), { result });
            }
            catch (error) {
                next(error);
            }
    ...
    */
    leaveGroup(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const userId = req.user._id;
            const groupId = req.params.id;
            const result = yield GroupService_1.default.userLeftGroup(userId, groupId);
            if (result.groupNotExist)
                return ResponseHelper_1.default.badRequest(res, res.__('Invalid_GroupId'));
            if (result.isAdmin)
                return ResponseHelper_1.default.badRequest(res, res.__('is_group_admin'));
            if (result.notGroupMember)
                return ResponseHelper_1.default.badRequest(res, res.__('Invalid_GroupId_Or_MemberId'));
            res.logMsg = `Group member removed *${userId}* from group *${groupId}*`;
            return ResponseHelper_1.default.ok(res, res.__('user_left_group'), { data: result });
        });
    }
    /**
    ...
    joinGroup(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield GroupService_1.default.joinGroup(groupId, req.user);
                if (result.groupNotExist)
                    return ResponseHelper_1.default.badRequest(res, res.__('invalid_groupId'));
                if (result.alreadyMember)
                    return ResponseHelper_1.default.badRequest(res, res.__('already_member'));
                res.logMsg = `*${req.user._id}* joined group *${groupId}*`;
                return ResponseHelper_1.default.created(res, res.__('group_joined'), { group: result.group });
            }
            catch (error) {
                next(error);
            }
